      ...
      <div className="flex flex-col justify-between gap-8  h-full">
        <ul className="mt-8 space-y-7 border-b pb-7 ">
          ...
          <li className="border-b pb-7">
            <NavItem to="/sample-projects" text="Sample projects">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="25"
          ...
          <li>
            <NavItem to="/intro-necleo" text="Intro ot Necleo">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
        ...
        <ul className="space-y-7">
          <li>
            <NavItem to="/help&support" text="Help & support">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
          ...
          <li>
            <NavItem to="/feedback" text="Feedback">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
                height="28"
